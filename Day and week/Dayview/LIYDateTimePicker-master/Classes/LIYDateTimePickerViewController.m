...
- (void)viewDidLoad {
    ...
    self.collectionView.backgroundColor = [UIColor collectionViewBackground];
...
-(void) setupSaveButton{
    ...
    saveButton.backgroundColor = [UIColor saveButtonBackgroundColor];
    [saveButton setTitle:@"Save" forState:UIControlStateNormal];
    saveButton.titleLabel.textColor = [UIColor saveButtonTitleColor];
...
-(void) setupFixedTimeSelector{
    ...
    self.fixedSelectedTimeLine.backgroundColor = [UIColor fixedTimeLineColor];
    ...
    self.fixedSelectedTimeBubble.layer.borderColor = [UIColor fixedTimeBubbleBorderColor].CGColor;
    self.fixedSelectedTimeBubble.layer.borderWidth = 1.0f;
    self.fixedSelectedTimeBubble.backgroundColor = [UIColor fixedTimeBubbleBackgroundColor];
    ...
    self.fixedSelectedTimeBubbleTime.textColor = [UIColor fixedTimeBubbleTextColor];
...
- (void)createDayPicker {
    ...
    //TODO: Fix Harcoded Date (Figure out why it is hardcoded)
...
- (void)setupConstraints {
    ...
    [self.view addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:self.showDayPicker ? @"V:[topLayoutGuide][dayPicker(84)][collectionView]|" : @"V:|[collectionView]|"
                               options:0
                               metrics:nil
...
- (void)setupTimeSelector {
    ...
    self.dragView.hidden = YES;
    self.dragView.backgroundColor = [UIColor dragBackgroundColor];
    ...
    self.dragLabel.textColor = [UIColor dragTextColor];
