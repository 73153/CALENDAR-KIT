...
@interface TBTaskTableViewController ()
...
@implementation TBTaskTableViewController
...
{
    [super viewDidLoad];
    _events = [[self dataSource] tableViewData];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self tableView:tableView didSelectEvent:[self events][[indexPath row]] withCell:cell];
...
- (void)tableView:(UITableView *)tableView didSelectEvent:(CKCalendarEvent *)event withCell:(UITableViewCell *)cell
{
    // Set operationCell
    _operationCell = cell;
